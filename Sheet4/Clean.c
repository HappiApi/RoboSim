...
//Bug - Does not stop if speed is set higher than 50
//Bug - Does not follow back properly if speed is 50  

#define FOLLOW_SPEED 50 //15 //35
#define FOLLOW_BK_SPD 50 //15
#define THRESHOLD_DIST 25.0 //35.0
